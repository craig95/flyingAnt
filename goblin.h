...
*
*	@brief A class for  creating clones of a specific type of monster (goblin mob).
*
*	@section Description
* 	This class provides the functionality of creating clones of the mob type Goblin, as well as give the mob the ability to attack another player or take damage itself.
*
*/
...
public:
	...
	Goblin();
		...
		/**
		*	This function creates a clone of a Goblin mob of type Unit.
		*	@return A pointer to a Goblin mob of type Unit.
		*/
	Unit* clone();

		/**
		*	This function "attacks" a player of type Unit.
		*	@param The Player of type Unit this goblin will be attacking (afflicting damage to).
		*	@return Nothing is returned (function is void).
		*/
	//virtual void attack(Unit&);

		/**
		*	This function lets this Goblin mob of type Unit take damage to itself.
		*	@param An integer indicating how much damage should be taken by the Goblin mob (how much the attribute Health will be decremented by).
		*	@return Nothing is returned (function is void).
		*/
