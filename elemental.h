...
*
*	@brief A class for  creating clones of a specific type of monster (elemental mob).
*
*	@section Description
* 	This class provides the functionality of creating clones of the mob type Elemental, as well as give the mob the ability to attack another player or take damage itself.
*
*/
...
public:
	...
	Elemental();
		...
		/**
		*	This function creates a clone of an Elemental mob of type Unit.
		*	@return A pointer to an Elemental mob of type Unit.
		*/
	Unit* clone();

		/**
		*	This function "attacks" a player of type Unit.
		*	@param The Player of type Unit this elemental will be attacking (afflicting damage to).
		*	@return Nothing is returned (function is void).
		*/
	//virtual void attack(Unit&);

		/**
		*	This function lets this Elemental mob of type Unit take damage to itself.
		*	@param An integer indicating how much damage should be taken by the Elemental mob (how much the attribute Health will be decremented by).
		*	@return Nothing is returned (function is void).
		*/
